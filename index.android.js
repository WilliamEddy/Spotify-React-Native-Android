...
class ReactNativeModuleTutorial extends Component {
  constructor(props){
    super(props);
    this.state = {
      mp3Url: 'https://ia802508.us.archive.org/5/items/testmp3testfile/mpthreetest.mp3',
      prepared: false,
      playing: false,
      duration: 0
    };
...
AppRegistry.registerComponent('AndroidSpotifyPlayground', () => ReactNativeModuleTutorial);